...
class ProductionConfig(Config):# 生产环境
    ...
    db = 'bid'
    charset = 'utf8'
    ml_file = 'C:\\bid\\crawler\\ml_code\\ml_purcharser_train.xlsx'
    item_file = 'C:\\bid\\crawler\\ml_code\\item_train.xlsx'
    stop_word = 'C:\\bid\crawler\\ml_code\\stopwords.txt'
...
class DevelopmentConfig(Config):  # 开发环境
    ...
    db = 'crawl_test'
    charset = 'utf8'
    ml_file = 'D:\\办公\\yizhaobiao\\my_git\\crawler\\ml_code\\ml_purcharser_train.xlsx'
    item_file = 'D:\\办公\\yizhaobiao\\my_git\\crawler\\ml_code\\item_train.xlsx'
    stop_word = 'D:\\办公\\yizhaobiao\\my_git\\crawler\\ml_code\\stopwords.txt'
...
class TestConfig(Config):
    ...
    db = 'crawl_test'
    charset = 'utf8'
    ml_file = '/crawler/crawler/ml_code/ml_purcharser_train.xlsx'
    item_file = '/crawler/crawler/ml_code/item_train.xlsx'
    stop_word = '/crawler/crawler/ml_code/stopwords.txt'
...
class Production_linux(Config):
    ...
    db = 'bid'
    charset = 'utf8'
    ml_file = '/bid/crawler/ml_code/ml_purcharser_train.xlsx'
    item_file = '/bid/crawler/ml_code/item_train.xlsx'
    stop_word = '/bid/crawler/ml_code/stopwords.txt'
